        ...
        <div className="bg-white mx-auto shadow rounded p-4 w-full md:w-[480px]">
                        ...
                        {cart.map((item) => (
                            <li key={item.id} className="py-2 flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button type="button" className="ml-3 text-sm text-red-600">
                                        Remove
                                    </button>
                                </div>
                            </li>
            ...
            <div className="mt-4">
                <div className="flex gap-2">
                    ...
                    />
                    <button type="button" className="px-3 py-2 bg-indigo-600 text-white rounded">
                        Apply
                    </button>
                </div>
            ...
            <div className="mt-4 flex gap-2">
                ...
                <button type="button" className="flex-1 bg-green-600 text-white rounded px-3 py-2" disabled={cart.length === 0}>
                    Checkout
                </button>
            </div>
        </div>
